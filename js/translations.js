...
window.GreenCapTranslations = {
  'pt-br': {
    ...
    problemItem2Text: 'Exigem componentes adicionais só para funcionar, o que aumenta o custo operacional de clusters de estudo, dev e teste.',
    ...
    step1Text: 'O setup sobe um cluster local (minikube) com a GreenCap. Já tem o seu? Conecte via kubeconfig, sempre encriptado antes de ser salvo.',
  ...
  'en': {
    ...
    problemItem2Text: 'They need extra components just to run, which adds operational cost to study, dev, and test clusters.',
    ...
    step1Text: 'Setup spins up a local cluster (minikube) with GreenCap. Already have one? Connect via kubeconfig, always encrypted before being saved.',
